...
/* Fix input-group-text to have blue background and white text */
.input-group-text {
  background-color: #050C9C !important;
...
/* Adjust input group overall styling for spacing and consistency */
.input-group {
...
/* Refined allResidenceTable Design */
#allResidenceTable {
  background-color: #F8FBFF; /* clean background */
  color: #000;
}
...
/* Row hover */
#allResidenceTable tbody tr:hover {
  background-color: #0047ab !important; /* light sky blue */
  cursor: pointer;
}

/* Optional: Clean border lines */
#allResidenceTable td,
#allResidenceTable th {
  border-color: #A7E6FF;
}

/* Optional: Add subtle shadow to header */
#allResidenceTable thead {
