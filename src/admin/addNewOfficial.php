...
try{
  if(isset($_SESSION['user_id']) && isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'admin'){
    ...
    // We don't need to fetch user info here, just check if they are admin
  }else{
    // Stop the script if not an admin
...
if($add_age_date >= '60'){
  ...
  // (We assume purok_id and date_undeleted are fixed on the DB side from Step 1)
