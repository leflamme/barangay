...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble " src="../assets/dist/img/logo/logo.png" alt="AdminLTELogo" height="70" width="70">
  </div>
                  ...
                  <div class="col-sm-12 text-center">
                    <?php 
                      ...
                      if($image != '' || $image != null || !empty($image)){
                        echo '<img src="'.$image_path.'" class="img-circle text-center" alt="logo"  id="display_image" style="cursor: pointer; height: 150px;">';
                      }else{
