...
try{
  ...
  if(isset($_REQUEST['record_id'])){
    ...
    if($row_record_blotter['middle_name'] != ''){
      $middle_name_view = $row_record_blotter['middle_name'][0].'.';
    }else{
      $middle_name_view = '';
    }
        
    if($row_record_blotter['image'] != '' || $row_record_blotter['image'] != null){
      $image = '<img class="img-circle elevation-2" src="'.$row_record_blotter['image_path'].'" alt="User Avatar">';
    }else{
                            ...
                            while($row_record_resident_id = $result_resident_id->fetch_assoc()){
                              ...
                              ?>
                                <option   value="<?= $row_record_resident_id['residence_id'] ?>" <?php
                                  ...
                                  // --- THIS IS THE FIXED COMPLAINANT QUERY ---
                            ...
                            while($row_person_id = $result_person_id->fetch_assoc()){
                              ...
                              ?>
                                <option value="<?= $row_person_id['residence_id'] ?>" <?php 
                                    ...
                                    // --- THIS IS THE FIXED PERSON INVOLVED QUERY ---
