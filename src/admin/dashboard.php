    ...
    <section class="content">
      <div class="container-fluid"> 
            <div class="row">
                <div class="col-sm-4">
                  <div class="row">
                    <!-- Each small box should be in its own col-sm-12 -->
                    <div class="col-sm-12">
                      <!-- Population Box -->
                                ...
                                <div class="col-sm-6 scrollOfficial">
                                    ...
                                    <ul class="users-list clearfix ">
                                          ...
                                          <li id="<?= $row_official['official_id'] ?>" class="viewOfficial" style="cursor: pointer">
                                            <?= $official_image; ?>
                                            <p class="users-list-name m-0 text-black" ><?= $row_official['first_name'].' '. $row_official['last_name'] ?> </p>
                                            <span class="users-list-date text-black" style="font-weight: 900"><?= strtoupper($row_official['position_official']) ?></span>
                                          </li>
    ...
    <div class="modal-content shadow-lg">
      ...
      <div class="px-4 pt-3">
        <div class="input-group mb-3">
          <input type="text" id="infoSearch" class="form-control"
