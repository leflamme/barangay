...
<!-- Add this after including select2 JS -->
<script>
$(document).ready(function() {
  // Enable select2 for purpose dropdown with search
  $('#purpose').select2({
    placeholder: "Type or select certificate purpose",
    allowClear: false,
    width: '100%',
    dropdownParent: $('#newRequestModal')
  });

  // Show/hide "Others" textbox based on selection
